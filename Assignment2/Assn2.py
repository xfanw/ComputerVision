...
cv.imwrite('keypoints_sift_first.jpg',img_kp_sift)
cv.imwrite('keypoints_sift_second.jpg',img2_kp_sift)
...
#Draw Img
cv.imwrite('keypoints_orb_first.jpg',img_kp_orb)
cv.imwrite('keypoints_orb_second.jpg',img2_kp_orb)
...
cv.imwrite('match_out_10.jpg',img_out_10)
cv.imwrite('match_out_20.jpg',img_out_20)
cv.imwrite('match_out_50.jpg',img_out_50)
...
cv.imwrite('match_out_Knn75.jpg',img_out_knn_75)
cv.imwrite('match_out_Knn50.jpg',img_out_knn_50)
cv.imwrite('match_out_Knn20.jpg',img_out_knn_20)
